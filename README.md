## nao_interfaces (jazzy) - 1.0.0-4

The packages in the `nao_interfaces` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy nao_interfaces --override-release-repository-push-url git@github.com:revyos-ros/nao_interfaces-release.git` on `Fri, 14 Jun 2024 02:22:16 -0000`
...
- release repository: https://github.com/revyos-ros/nao_interfaces-release.git
